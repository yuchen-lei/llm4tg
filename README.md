...
We denote \texttt{T} as transaction and \texttt{A} as address. \texttt{<NodeID>} represents the node's ID, \texttt{<Number>} represents an integer. \texttt{<Float>} represents a real number. The **LLM4TG syntax** is displayed as follows:
